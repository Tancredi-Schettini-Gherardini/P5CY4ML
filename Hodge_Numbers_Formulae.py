# -*- coding: utf-8 -*-
"""
Created on Wed Sep 13 22:02:57 2023
...
#%% --------------------------------------------------------------------------------------
#   We now illustrate how to use the above funcions with some examples.

#%% Example with a simple C-Y three-fold, together with the computational times.
...
print(exact_poly)
print("...from which we read the following Hodge numbers (in lexicographic order):")
print(Hodge_reader_3folds(exact_poly))
print("The computational time was:")
print(time_e)
print("---------------------------------------")
print("The truncated polynomial is:")
print(approximated_poly)
print("...from which we read the following approximated Hodge numbers (in lexicographic order):")
print(Hodge_reader_3folds(approximated_poly))
print("The computational time was:")
print(time_a)

#%% Example with a simple C-Y four-fold, together with the computational times.

example_weight_threefold = [ 10,  27,  36,  38, 159, 234]
...
print(exact_poly)
print("...from which we read the following Hodge numbers (in lexicographic order):")
print(Hodge_reader_4folds(exact_poly))
print("The computational time was:")
print(time_e)
print("---------------------------------------")
print("The truncated polynomial is:")
print(approximated_poly)
print("...from which we read the following approximated Hodge numbers (in lexicographic order):")
print(Hodge_reader_4folds(approximated_poly))
print("The computational time was:")
print(time_a)
